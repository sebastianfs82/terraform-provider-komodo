...
description: |-
  Lists docker networks on Komodo-managed servers. Optionally filter by a single server.
---
...
- `server_id` (String) Filter networks by server ID or name. If omitted, all servers are queried.
