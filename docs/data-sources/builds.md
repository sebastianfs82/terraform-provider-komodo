...
- `builder_id` (String) Filter builds by builder ID. When set, only builds using this builder are returned.
- `repo_id` (String) Filter builds by linked repo ID. When set, only builds sourced from this repo are returned.
