...
- `repo_id` (String) Filter stacks by linked repo ID or name. When set, only stacks sourced from this repo are returned.
- `server_id` (String) Filter stacks by server ID. When set, only stacks deployed on this server are returned.
