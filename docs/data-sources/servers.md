...
page_title: "komodo_servers Data Source - terraform-provider-komodo"
subcategory: ""
description: |-
...
output "server_names" {
  value = [for s in data.komodo_servers.all.servers : s.name]
}
```
...
- `servers` (List of Object) The list of servers. (see [below for nested schema](#nestedatt--servers))
